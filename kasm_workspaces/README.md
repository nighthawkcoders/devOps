...
![Screenshot 2023-08-10 at 7 23 20 PM](https://github.com/nighthawkcoders/devOps/assets/50186752/ce2bbb8b-d1b3-4c37-b6be-63835cce0997)
![Screenshot 2023-08-10 at 7 27 49 PM](https://github.com/nighthawkcoders/devOps/assets/50186752/b3f28aa5-3fb9-493b-80df-cf75ae09102c)

5. Then run `pip install -r requirements.txt` to install the required python packages.
6. Lastly, run `python student_management.py` and all users created will be logged in the user_creation_log.md file.
